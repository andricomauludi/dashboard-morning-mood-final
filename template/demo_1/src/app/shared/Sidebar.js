    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
            ...
            <div className="profile-desc">
              <div className="profile-pic">
                <div className="count-indicator">
                  <img className="img-xs rounded-circle " src={require('../../assets/images/faces/profile-teams.jpg')} alt="profile" />
                  <span className="count bg-success"></span>
                </div>
                <div className="profile-name">
                  <h5 className="mb-0 font-weight-normal"><Trans>Andrico Mauludi</Trans></h5>
                  <span><Trans>Fullstack Developer</Trans></span>
                </div>
              </div>
              <Dropdown alignRight>
          ...
          <li className={ this.isPathActive('/inventory') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <Link className="nav-link" to="/inventory/show">
              <span className="menu-icon"><i className="mdi mdi-basket"></i></span>
          ...
          <li className={ this.isPathActive('/pos') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <Link className="nav-link" to="/pos">
              ...
              <span className="menu-title"><Trans>Kasir</Trans></span>
            </Link>
          </li>
